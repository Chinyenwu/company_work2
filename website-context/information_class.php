...
<body>
    <div class="page-header">
        <h1 style="text-align: center;"> 歡迎, <b><?php echo htmlspecialchars($_SESSION["username"]); ?></b>這裡是網站功能-公告類別</h1>
    </div>
...
<div style="position:absolute;  left:0; top:0">
        <ul style="float:left">
            <li style="list-style-type:none;" ><button onclick="location.href='font_main.php'" type="button" class="btn btn-warning">前台首頁</button></li>
        </ul>       
        <ul style="float:left">
            <li style="list-style-type:none;" class="member"><button  onclick="location.href='#'" type="button" class="btn btn-warning">公告</button></li>
        ...
        <ul style="float:left">
            <li style="list-style-type:none;" class="member2"><button onclick="location.href='#'" type="button" class="btn btn-warning">檔案室</button></li>
        ...
        <ul style="float:left">
            <li style="list-style-type:none;" class="member4"><button onclick="location.href='#'" type="button" class="btn btn-warning">問與答</button></li>
        ...
        <ul style="float:left">
            <li style="list-style-type:none;" class="member6"><button href="#" type="button" class="btn btn-warning">頁面</button></li>
    ...
    <div class="wrapper">       
        <h2>新增類別</h2>
        <form action="information_class_insert.php" method="post">
    ...
    if ($result->num_rows > 0) {
        // output data of each row
         while($row = $result->fetch_assoc()) {
           ...
           $id=$row["id"]; 
             ?>
            <form  action="information_class_change.php" method="post" style="display: inline;">
             ...
             <form action="information_class_delete.php" method="post" style="display: inline;">
                <input type="hidden" name="id" value="<?php echo $id; ?>"/> 
