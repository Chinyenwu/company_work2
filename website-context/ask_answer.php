...
<div align="center">
    ...
    ?>
        ...
        <form action="information_insert" method="post">
            ...
            <div class="form-group ">
                <label>提問者</label>
                <input type="text" name="asker" class="form-control" value="<?php echo $asker; ?>">
            </div>
            ...
            <div class="form-group ">
                <label>回答者</label>
                <input type="text" name="answerker" class="form-control" value="<?php echo $answerker; ?>">
            </div>

            <div class="form-group ">
                <label>回答</label>
                <!--<input type="text" name="context" class="form-control" value="<?php //echo $context; ?>">-->
                      <textarea id="editor1"  name="answer"><?php echo $answer; ?></textarea>
            </div>
            <script>
