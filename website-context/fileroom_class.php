...
<body>
    <div class="page-header">
        <h1 style="text-align: center;"> 歡迎, <b><?php echo htmlspecialchars($_SESSION["username"]); ?></b>這裡是檔案室類別</h1>
    </div>
...
<div style="position:absolute;  left:0; top:0">
    ...
    <div class="wrapper">       
        <h2>新增類別</h2>
        <form action="fileroom_class_insert.php" method="post">
            ...
            <div class="form-group ">
                <label>類別id</label>
                <input type="text" name="class_id" class="form-control" value="<?php $class_id=null; echo $class_id; ?>">
            </div> 
            <div class="form-group">
    ...
    if ($result->num_rows > 0) {
        // output data of each row
         while($row = $result->fetch_assoc()) {
           ...
           $id=$row["id"]; 
             ?>
            <form  action="fileroom_class_change.php" method="post" style="display: inline;">
             ...
             <form action="fileroom_class_delete.php" method="post" style="display: inline;">
                <input type="hidden" name="id" value="<?php echo $id; ?>"/> 
