...
<body>
    <div class="page-header">
        <h1 style="text-align: center;"> 歡迎, <b><?php echo htmlspecialchars($_SESSION["username"]); ?></b>. 您是這個網站的超級管理者</h1>
    </div>
...
<div style="position:absolute;  left:0; top:0;">
        ...
        <ul style="float:left;">
            ...
            <li style="list-style-type:none; display:none; " class="memberl"><button onclick="location.href='manager/permission.php'" class="btn btn-warning">會員列表</button></li>
            <li style="list-style-type:none; display:none; " class="memberl"><button onclick="location.href='manager/member_add.php'" class="btn btn-warning">新增使用者</button></li>
            <li style="list-style-type:none; display:none; " class="memberl"><button onclick="location.href='manager/position_list.php'" class="btn btn-warning">職稱調整</button></li>
            <li style="list-style-type:none; display:none; " class="memberl"><button onclick="location.href='manager/position_add.php'" class="btn btn-warning">新增職稱</button></li>
        </ul>
        <ul style="float:left;">
            <li style="list-style-type:none;"  class="member2"><button onclick="location.href='#" class="btn btn-warning">期刊</button></li>
            <li style="list-style-type:none; display:none; " class="member3"><button onclick="location.href='journal/journal.php'" class="btn btn-warning">期刊</button></li>
            <li style="list-style-type:none; display:none; " class="member3"><button onclick="location.href='journal/honor.php'" class="btn btn-warning">榮譽</button></li>
        </ul>
</div>
    <?php
...
<div class="wrapper">
            ...
            <!--<div class="form-group ">
            <input type="file" name="upload_picture"  accept="image/*" title="SystemAdmin" style="position:absolute; top:7em; right:0; opacity: 0; height: 200px; width: 150px; z-index: 10;"  src="<?php //echo $image_path; ?>">-->

            <!--<img id="defalut_picture" onclick="openfileDialog()" src="userimage/none-photo.jpg" alt="Image text" style="border-width:0px;position:absolute; top:7em; right:0; height: 200px; width: 150px; z-index: 1;">-->
